...
const Experiments = () => {
  ...
  const addExperiment = (user) => {
    setParams(user);
    handleShow();
  };

  const editexperiment = (chemical) => {
    setParams(chemical);
    handleShow();
  };
  ...
  const deleteExperiment = async (user) => {
    try {
    ...
    <div className="container-fluid">
      ...
      <div className="row">
        ...
        <div className="col p-4">
          ...
          {/* Modal for Adding Experiments */}
          <Modal show={showModal} onHide={handleClose}>
            <Modal.Header closeButton>
              <Modal.Title>{"Add Experiment"}</Modal.Title>
            </Modal.Header>
            <Modal.Body>
              <form>
                <div className="mb-3">
                ...
                <div className="mb-3">
                  <label htmlFor="chemicals" className="form-label">
                    Chemicals
                  </label>
                  {/* <input
                    type="password"
                  ...
                  /> */}
                  <select name="chemical" id="chemical" className="form-control">
                    <option value="chemical1">Chemical1</option>
                    <option value="chemical2">Chemical2</option>
                    <option value="chemical3">Chemical3</option>
                  </select>
            ...
            <Modal.Footer>
              ...
              >
                {params.id ? "Save Changes" : "Add Experiment"}
              </button>
            </Modal.Footer>
          </Modal>

          {/* Modal for update order */}
          <Modal show={showOrderModal} onHide={handleOrderClose}>
            <Modal.Header closeButton>
            ...
            <Modal.Body>
              <form>
              <div className="mb-3">
              Do you recevied chemicals of Experiment?
                </div>
              </form>
            </Modal.Body>
            <Modal.Footer>
